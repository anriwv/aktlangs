...
* [SQLite](src/main/java/toylangs/sqelite). Väike SQL-laadne andmetöötluskeel lihtsate päringute tegemiseks listide peal, kus võib esineda elementide filtreerimine (`where`) ja tulemuste teisendamine (`select`). (Autor: Anri Sokolov.)