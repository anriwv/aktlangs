...
* [SQLite](src/main/java/toylangs/sqlite). Väike SQL-laadne andmetöötluskeel lihtsate päringute tegemiseks listide peal, kus esineb elementide filtreerimine (`where`) ja tulemuste teisendamine (`select`). (Autor: Anri Sokolov.)